    ...
    <div class="container">
      ...
      <div class="quick-actions">
        <a-button
          ...
          @click="
            setPrompt(
              '创建一个现代化的个人博客网站，包含文章列表、详情页和个人简介页面。采用简洁的设计风格，支持响应式布局，首页展示精选文章。代码总量控制在100行以内。',
            )
          "
          >个人博客网站</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '设计一个专业的企业官网，包含公司介绍、产品服务展示、新闻资讯、联系我们等页面。采用商务风格的设计，包含轮播图、产品展示卡片、团队介绍、客户案例展示，支持多语言切换和在线客服功能。要求使用Vue项目模式，每个文件不超过50行代码。',
            )
          "
          >企业官网</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '构建一个功能完整的在线商城，包含商品展示、购物车、用户注册登录、订单管理、支付结算等功能。设计现代化的商品卡片布局，支持商品搜索筛选、用户评价、优惠券系统和会员积分功能。代码总量控制在200行以内。',
            )
          "
          >在线商城</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '制作一个精美的作品展示网站，适合设计师、摄影师、艺术家等创作者。包含作品画廊、项目详情页、个人简历、联系方式等模块。采用瀑布流或网格布局展示作品，支持图片放大预览和作品分类筛选。要求使用Vue项目模式，每个文件不超过50行代码。',
            )
          "
          >作品展示网站</a-button
        >
