    ...
    <div class="container">
      ...
      <div class="quick-actions">
        ...
        <a-button
          ...
          @click="
            setPrompt(
              '设计一个专业的企业官网，包含公司介绍、产品服务展示、新闻资讯、联系我们等页面。采用商务风格的设计，包含轮播图、产品展示卡片、团队介绍、客户案例展示，支持多语言切换和在线客服功能。每个文件不超过50行代码，使用Vue工程模式。',
            )
          "
          >企业官网</a-button
        >
        ...
        <a-button
          ...
          @click="
            setPrompt(
              '制作一个精美的作品展示网站，适合设计师、摄影师、艺术家等创作者。包含作品画廊、项目详情页、个人简历、联系方式等模块。采用瀑布流或网格布局展示作品，支持图片放大预览和作品分类筛选。每个文件不超过50行代码，使用Vue工程模式。',
            )
          "
          >作品展示网站</a-button
        >
