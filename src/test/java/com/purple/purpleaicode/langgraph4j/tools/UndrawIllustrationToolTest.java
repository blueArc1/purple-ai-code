package com.purple.purpleaicode.langgraph4j.tools;

import com.purple.purpleaicode.langgraph4j.model.ImageResource;
import com.purple.purpleaicode.langgraph4j.model.enums.ImageCategoryEnum;
...
class UndrawIllustrationToolTest {
    ...
    void testSearchIllustrations() {
        // 测试正常搜索插画
        List<ImageResource> illustrations = undrawIllustrationTool.searchIllustrations("phone");
