...
public class AppController {
    ...
    public void downloadAppCode(@PathVariable Long appId, HttpServletRequest request,
        ...
        ThrowUtils.throwIf(!sourceDir.exists() || !sourceDir.isDirectory(), ErrorCode.NOT_FOUND_ERROR,
                "应用代码不存在，请先生成代码");
        // 6.生成下载文件名（不建议添加中文内容）
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.purple.purpleaicode.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
